...
class MoveGroupActionClient(Node):
    ...
    def __init__(self):
        ...
        joints = {}
        joints['shoulder_pan_joint'] = angles[0]#-1.6391
        joints['shoulder_lift_joint'] = angles[1]#-0.1366
        joints['elbow_joint'] = angles[2]#-2.0147
        joints['wrist_1_joint'] = angles[3]#-0.7512
        joints['wrist_2_joint'] = angles[4]#1.5708
