...
class ComputeIK(Node):
    ...
    def send_request(self):
        ...
        if status_second:
            pose_can_point.z = 0.3
            pose_can_orientation.z = -0.7071068
            pose_can_orientation.w = 0.7071068
        else:
            pose_can_point.z = 0.3
            pose_can_orientation.z = 0.0
            pose_can_orientation.w = 1.0
...
def execute(self, inputs, outputs, gvm):
    ...
    status_second = inputs['status_second']
    status_third = inputs['status_third']
